            ...
            <div className="legal-container">
                ...
                <section className="legal-section">
                    ...
                    <p>Cookies, die zur Durchf&uuml;hrung des elektronischen Kommunikationsvorgangs, zur Bereitstellung
                        ...
                        Abs. 1 TTDSG); die Einwilligung ist jederzeit widerrufbar.</p>
                    ...
                    <p>Welche Cookies und Dienste auf dieser Website eingesetzt werden, k&ouml;nnen Sie dieser
                        Datenschutzerkl&auml;rung entnehmen.</p>
                    <h3>Cloudflare</h3>
                    <p>Wir nutzen das Content Delivery Network (CDN) von Cloudflare Germany GmbH, Rosental 7, c/o
                        ...
                        vergleichen Sie die Ausführungen unter „Hosting".</p>
                    <p>Cloudflare ist Empfänger Ihrer personenbezogenen Daten und als Auftragsverarbeiter für uns tätig.
                        Die entspricht unserem berechtigten Interesse im Sinne des Art. 6 Abs. 1 S. 1 lit. f DSGVO,
                        selbst kein Content Delivery Network zu betreiben.</p>
                    ...
                    <p>Die Verarbeitung der unter diesem Abschnitt angegebenen Daten ist weder gesetzlich noch
                        ...
                        gewährleistet.</p>
                    <p>Ihre personenbezogenen Daten werden von Cloudflare so lange gespeichert, wie es für die
                        beschriebenen Zwecke erforderlich ist.</p>
                    <p>Weitere Informationen zu Widerspruchs- und Beseitigungsmöglichkeiten gegenüber Cloudflare finden
                        Sie unter: <a href="https://www.cloudflare.com/de-de/cloudflare-customer-dpa/" target="_blank">Cloudflare
                            DPA</a></p>
                    <p>Cloudflare hat Compliance-Maßnahmen für internationale Datenübermittlungen umgesetzt. Diese
                        gelten für alle weltweiten Aktivitäten, bei denen Cloudflare personenbezogene Daten von
                        natürlichen Personen in der EU verarbeitet. Diese Maßnahmen basieren auf den
                        EU-Standardvertragsklauseln (SCCs). Weitere Informationen finden Sie <a
                            href="https://www.cloudflare.com/cloudflare_customer_SCCs-German.pdf"
                            target="_blank">hier</a>.</p>
                </section>

                <p className="sources">Quellen: <a href="https://www.e-recht24.de" target="_blank">eRecht24</a>, <a
